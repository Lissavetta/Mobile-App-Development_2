package ru.mirea.tropina.dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btPickDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ru.mirea.tropina.dialog.MyDateDialogFragment mDatePickerDialogFragment;
                mDatePickerDialogFragment = new ru.mirea.tropina.dialog.MyDateDialogFragment();
